...
a4988DriveModule::a4988DriveModule(stepperMotor motor, int gearRatio, int microStepsPerStep, float maxAngle, int limitPin=NULL, direction dirToSwitch=CLOCKWISE)
...
void a4988DriveModule::zero() {
    if (limitPin == NULL && dirToSwitch == NULL) return;
